...
namespace AvaloniaPdbAccounts
{
    public partial class MainWindow : Window
    {
        ...
        private async void ObjectNameComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            _selectedObjectName = _privilegeGrant.SelectedObjectName;
        }
        ...
        private async void GrantPrivilege_Click(object sender, RoutedEventArgs e)
        {
                ...
                PrivilegeComboBox.SelectedItem != null)
            {
                ...
                Console.WriteLine($"Selected Privilege: {selectedPrivilege}");  
                Console.WriteLine($"Selected Object Type: {selectedObjectType}");
                Console.WriteLine($"Selected Object Name: {selectedObjectName}");
                Console.WriteLine($"Selected Column Name: {selectedColumnName}");
                Console.WriteLine($"With Grant Option: {withGrantOption}");
