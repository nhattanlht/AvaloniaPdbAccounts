...
GRANT SELECT, INSERT, UPDATE, DELETE ON ADMINPDB.DANGKY TO SV;
...
-- INSERT INTO adminpdb.DANGKY (MASV, MAMM, DIEMTH, DIEMQT, DIEMCK, DIEMTK)
-- VALUES ('A536166', 'MTH00003_2_2025', NULL, NULL, NULL, NULL);

-- CONN A536166/123@localhost:1521/PDB;
-- DELETE FROM adminpdb.DANGKY WHERE MASV = 'A536166' AND MAMM = 'MTH00003_2_2025';

-- CONN A536166/123@localhost:1521/PDB;
-- SELECT * FROM adminpdb.DANGKY;
