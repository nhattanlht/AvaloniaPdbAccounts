-- Chuyển về CDB$ROOT trước khi xóa PDB1
ALTER SESSION SET CONTAINER = CDB$ROOT;

-- Xóa PDB1 nếu có
BEGIN
    EXECUTE IMMEDIATE 'ALTER PLUGGABLE DATABASE PDB1 CLOSE IMMEDIATE';
EXCEPTION
    WHEN OTHERS THEN NULL; -- Bỏ qua nếu PDB1 không tồn tại
END;
/

BEGIN
    EXECUTE IMMEDIATE 'DROP PLUGGABLE DATABASE PDB1 INCLUDING DATAFILES';
EXCEPTION
    WHEN OTHERS THEN NULL; -- Bỏ qua nếu PDB1 không tồn tại
END;
/
...
CREATE PLUGGABLE DATABASE PDB1
  ADMIN USER AdminPdb1 IDENTIFIED BY 123
  ROLES = (DBA)
  FILE_NAME_CONVERT = ('/pdbseed/', '/PDB1/');

--   FILE_NAME_CONVERT = (
--     'C:\APP\ADMIN\PRODUCT\23AI\ORADATA\FREE\PDBSEED\', 
--     'C:\APP\ADMIN\PRODUCT\23AI\ORADATA\FREE\PDB1\'
-- );
...
BEGIN
    ...
    IF v_open_mode != 'READ WRITE' THEN
        ...
        DBMS_OUTPUT.PUT_LINE('PDB1 ' || p_pdb_name || ' đã được mở.');
    ELSE
        DBMS_OUTPUT.PUT_LINE('PDB1 ' || p_pdb_name || ' đã mở sẵn.');
    END IF;
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        DBMS_OUTPUT.PUT_LINE('Không tìm thấy PDB1 tên: ' || p_pdb_name);
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Lỗi: ' || SQLERRM);
END;
/
EXECUTE Open_PDB_If_Closed('PDB1');
/



-- 1. Connect as SYS and prepare environment
CONNECT sys/123456@localhost:1521/PDB1 AS SYSDBA;
...
CONNECT ols_admin/123@localhost:1521/PDB1;
...
CONN ols_admin/123@localhost:1521/PDB1;
