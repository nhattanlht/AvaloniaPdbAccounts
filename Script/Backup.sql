...
FROM ADMINPDB.DANGKY AS OF TIMESTAMP 
    TO_TIMESTAMP('2025-06-19 12:41:38', 'YYYY-MM-DD HH24:MI:SS')
WHERE MASV = 'A536166';
...
BEGIN
  UNDO_DIEM_FROMTIME(
    'A536166',
    TO_TIMESTAMP('2025-06-19 10:45:45', 'YYYY-MM-DD HH24:MI:SS')
  );
END;
/
...
BEGIN
  UNDO_LUONG('NV00001', TO_TIMESTAMP('2025-06-19 10:39:52', 'YYYY-MM-DD HH24:MI:SS'));
END;
/
